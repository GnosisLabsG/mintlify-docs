...
<CardGroup cols={2}>
  <Card
    ...
    icon="shield-check"
    href="/developer-guides/identity-verification"
  >
    Deep dive into secure user authentication and verification
  </Card>
  <Card
    title="📚 JavaScript SDK"
    icon="code"
  ...
  >
    Set up real-time notifications for document processing and events
  </Card>
  <Card
    title="🏗️ Integration Examples"
    icon="puzzle-piece"
    href="/developer-guides/integrations/educational-platforms"
  >
    Real-world examples for common use cases and platforms
  </Card>
</CardGroup>
...
<Tip>
**Need help?** Join our [Discord community](https://discord.gg/mind-e) for real-time support, or check out our [GitHub examples](https://github.com/mind-e/examples) for complete implementation samples.
</Tip>